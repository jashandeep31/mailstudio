...
import {
  getUserCreditGrandsHistory,
  getUserPlan,
} from "../controllers/user/user-plan-controller.js";
...
import { getUserPayments } from "../controllers/user/user-payments-controller.js";
...
routes
  ...
  .get(checkAuthorization(["all"]), getUserCreditGrandsHistory);
...
routes.route("/payments").get(checkAuthorization(["all"]), getUserPayments);
routes
